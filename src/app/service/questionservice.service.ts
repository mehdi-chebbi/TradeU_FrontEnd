...
export class QuestionserviceService {
  ...
  private baseUrl = 'http://localhost:8083/QuestionController/'; // Replace this with your backend API URL
  private baseUrl2 = 'http://localhost:8083/ReponseSonController/'
